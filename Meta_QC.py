...
# -*- encoding: utf-8 -*-
"""	@package Meta_QC.py
	@brief	Implementacao das funções para o controle de qualidade
"""
...
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT	Diretorio para saida das amostras
# @param 	read1	nome do arquivo sem o identificador 
# @param 	read2	nome do arquivo sem o identificador caso as amostras sejam paired-end 
...
## Função Que executa o fastqDump caso as amostras sejam no NCBI
# @param 	CODE	lista com os identificadores das amostras gerada pela função sampleMetaData
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT		Diretorio para saida das amostras
# @param 	layout	se as amostras são single-end ou paired-end
...
## Função que exibe a qualidade das amostras
# @param 	CODE	lista com os identificadores das amostras gerada pela função sampleMetaData
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT	Diretorio para saida das amostras
# @param 	layout	se as amostras são single-end ou paired-end
...
## Função realizar o merge das sequencias das amostras paired-end
# @param 	CODE	lista com os identificadores das amostras gerada pela função sampleMetaData
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT	Diretorio para saida das amostras
# @param 	layout	se as amostras são single-end ou paired-end
...
## Função remover os adptadores das amostras
# @param 	CODE	lista com os identificadores das amostras gerada pela função sampleMetaData
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT	Diretorio para saida das amostras
# @param 	layout	se as amostras são single-end ou paired-end
...
## Função para remover os contaminantes idesejados das amostras
# @param 	CODE	lista com os identificadores das amostras gerada pela função sampleMetaData
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT	Diretorio para saida das amostras
# @param 	layout	se as amostras são single-end ou paired-end
...
## 	Função que cria os arquivos de configuração do QIIME 1
# @param 	CODE	lista com os identificadores das amostras gerada pela função sampleMetaData
# @param 	DIR_INPUT	Diretorio contendo as amostras
# @param 	DIR_OUT	Diretorio para saida das amostras
# @param 	layout	se as amostras são single-end ou paired-end
