...
def make_heatmap(DIR_INPUT, DIR_OUT, sampleName, category="-", imageType="pdf"):
	...
	if(category != "-"):
		os.system("make_otu_heatmap.py -i "+  + " -o " + DIR_OUT + "heatmap -c " + category + " -m " + sampleName + " -g " + imageType)
	else:
		os.system("make_otu_heatmap.py -i "+  + " -o " + DIR_OUT + "heatmap -m " + sampleName + " -g " + imageType)
...
"""	produz esta árvore a partir de um alinhamento de seqüência múltipla.
Exemplo:
"""
def make_phylogeny():
	print("Ola mundo!")
